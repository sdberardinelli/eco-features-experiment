...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/eco-feature: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/eco-feature ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/src/Creature.o: src/Creature.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Creature.o src/Creature.cpp

${OBJECTDIR}/src/Feature.o: src/Feature.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Feature.o src/Feature.cpp
...
${OBJECTDIR}/src/Subregion.o: src/Subregion.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Subregion.o src/Subregion.cpp
...
${OBJECTDIR}/src/TransformFunctions.o: src/TransformFunctions.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TransformFunctions.o src/TransformFunctions.cpp
